      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            name: '包装线 02',
            level: '产线',
            summary: '设备 9 台 · 运行 7 · 通信异常 1',
            status: '待机',
            children: [
              { id: 'EQ-AOI-001', name: 'AOI 检测机 01', level: '设备', summary: '3 分钟未更新，通信中断', status: '待机' },
            ],
          },
          {
            id: 'LINE-PKG-03',
...
export const equipmentModule: ModuleConfig = {
  ...
  metrics: [
    { label: '设备总数', value: '46', hint: '关键设备 18 台', tone: 'blue' },
    { label: '运行设备', value: '38', hint: '运行率 82.6%', tone: 'green' },
    { label: '当前报警', value: '2', hint: '1 项影响生产', tone: 'red' },
    { label: '通信异常', value: '1', hint: '3 分钟未更新', tone: 'amber' },
  ],
  tabs: [
    defineTab({
      name: '设备台账',
      ...
      data: [
        ...
        ['EQ-AOI-001', 'AOI 检测机 01', 'AOI 检测机', 'AOI-V3', 'LINE-PKG-02', '二车间（包装）', '陈杰', '3 分钟前', '待机'],
    ...
    defineTab({
      ...
      data: [
        ...
        ['RT-AOI-001-LINK', 'EQ-AOI-001 · AOI 检测机 01', '通信心跳', '无数据', '≤ 60 秒', '3 分钟前', 'LINE-PKG-02', '待机'],
      ],
    }),
    defineTab({
      name: '报警记录',
      ...
      data: [
        ...
        ['ALARM20260901002', 'EQ-AOI-001 · AOI 检测机 01', 'E-501', '通信数据中断超过 60 秒', '中', '09-01 11:20', '—', '陈杰', '待处理'],
    ...
    defineTab({
      ...
      prefix: 'DATA',
      createLabel: '新增采集记录',
      columns: 'id:采集编号, device:设备*, point:点位编码, name:业务字段*, value:采集值, unit:单位, freq:采集频率, time:采集时间, status:数据质量',
      data: [
        ...
        ['DATA20260901006', 'EQ-AOI-001 · AOI 检测机 01', 'PLC_A01_NG', '检出不良数', '—', '只', '30 秒', '09-01 11:56:40', '缺失'],
      ],
    }),
  ],
}
